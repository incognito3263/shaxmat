        ...
        <div className="lg:col-span-5 space-y-8">
          <div className="p-10 rounded-[2rem] text-center relative overflow-hidden bg-[#262421] border border-[#403d39] shadow-2xl">
            ...
            <div className="flex flex-col items-center gap-6">
              <div className="flex items-center gap-4 px-8 py-3 rounded-xl border border-[#403d39] bg-[#211f1d] cursor-pointer hover:bg-[#3c3a37] transition-all shadow-inner" onClick={() => { navigator.clipboard.writeText(user?.public_id || ''); setNotification({ text: t.idCopied, type: 'success' }); }}>

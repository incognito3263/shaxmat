...
const ClassicBase = ({ color, children, size = "100%" }: React.PropsWithChildren<PieceProps>) => {
  ...
  // Clean flat professional colors
...
export const ClassicKing = (props: PieceProps) => (
  <ClassicBase {...props}>
    <path d="M22.5 11.63V6M20 8h5" fill="none" strokeWidth="2" />
    <path d="M22.5 25s4.5-7.5 4.5-10.5c0-2.1-1.69-3.5-3.5-3.5s-3.5 1.4-3.5 3.5c0 3 4.5 10.5 4.5 10.5" />
...
export const ClassicQueen = (props: PieceProps) => (
  <ClassicBase {...props}>
    ...
    <path d="M11.5 30c3.5-1 18.5-1 22 0M11.5 33.5c3.5-1 18.5-1 22 0" fill="none" />
...
export const ClassicKnight = (props: PieceProps) => (
  <ClassicBase {...props}>
    ...
    <path d="M24 18c.38 2.43-4.65 7.32-6 10-3 6-1 11-1 11" fill="none" />
    <path d="M15 15.5c4.5 2 5 2 10 0 0 0-2.5-2.5-2.5-4s.5-4 .5-4c-1.49.3-2 2.35-3 2.5L15 15.5z" />
    <circle cx="27" cy="14" r="1" fill={props.color === 'white' ? '#000' : '#fff'} stroke="none" />
  </ClassicBase>
);
...
export const ClassicSupplier = (props: PieceProps) => (
  <ClassicBase {...props}>
    <path d="M22.5 8l8 9-8 9-8-9 8-9z" />
    <path d="M22.5 26v6" fill="none" />
    <path d="M15 35c0-3 2-5 5-6h5c3 1 5 3 5 6v2H15v-2z" />
  </ClassicBase>
);
